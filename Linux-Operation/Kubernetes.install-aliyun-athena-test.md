...
复制了文件：Kubernetes.install-aliyun-athena.md

# 环境概述

- 阿里云 (athena) ECS (2C 8G) x2
- CentOS 7.8
- 118.31.165.185 (172.16.113.210): k8s-m1 (master)
- 118.31.166.130 (172.16.113.211): k8s-w1 (worker)
...
```
172.16.113.210 k8s-m1
172.16.113.211 k8s-w1
```
...
#master地址
controlPlaneEndpoint: "172.16.113.210:6443"	
networking:
...
apiServer:
  ...
  - k8s-m1        #请替换为hostname
  - 118.31.165.185  #请替换为公网
  - 172.16.113.210  #请替换为私网
...
and service account keys on each node and then running the following as root:
  ...
  kubeadm join 172.16.113.210:6443 --token wiz7tb.afscifnyfqqawb50 \
