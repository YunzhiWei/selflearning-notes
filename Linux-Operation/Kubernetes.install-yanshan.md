...
- 燕山机房虚拟机 (yanshan) (2C 8G 60G) x2
- CentOS 7.8
- 111.204.133.182(13.129.3.54): k8s-m1 (master)
- xxx.xxx.xxx.xxx(13.129.3.55): k8s-w1 (worker)
...
#master地址
controlPlaneEndpoint: "13.129.3.54:6443"	
networking:
...
and service account keys on each node and then running the following as root:
  ...
  kubeadm join 13.129.3.54:6443 --token 7me5e8.im9mjhww7jefvblk \
    --discovery-token-ca-cert-hash sha256:16d32d9822960bdaae8e3a8463067e49f740616bf3aab4ccc101d76448de531e \
    --control-plane 
...
- registry.cn-beijing.aliyuncs.com/caskbank/service:0.5.7-yanshan
- registry.cn-beijing.aliyuncs.com/caskbank/frontend:0.5.7-yanshan
...
#### Start yanshan project

```
kubectl get pods --all-namespaces
kubectl get pods -n yanshan-demo
```